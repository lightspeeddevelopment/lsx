...
!function (e, o, s, t) {
  ...
  lsx.add_class_browser_to_html = function () {
    ...
    e(".lazyload, .lazyloaded").length > 0 && "object" == (typeof envira_isotopes === "undefined" ? "undefined" : _typeof(envira_isotopes)) && a.scroll(function () {
      e(".envira-gallery-wrap").each(function () {
        var o = e(this).attr("id");
        o = o.replace("envira-gallery-wrap-", ""), "object" == _typeof(envira_isotopes[o]) && envira_isotopes[o].enviratope("layout");
      });
    });
    ...
    l > 1199 && e("body").hasClass("top-menu-fixed") && n.on("scroll", function (s) {
      !1 === o && (e(lsx_params.stickyMenuSelector).scrollToFixed({
        ...
        preUnfixed: function preUnfixed() {
