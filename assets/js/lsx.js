...
!(function (e, o, s, t) {
	...
	(lsx.add_class_browser_to_html = function () {
		if ("undefined" != typeof platform) {
			...
			var s = "69";
			null !== platform.version && (s = platform.version.toLowerCase()),
				e("html").addClass(o).addClass(s);
		}
	}),
		...
		(lsx.navbar_toggle_handler = function () {
			e(".navbar-toggle")
				...
				.on("click", function () {
					var o = e(this);
					o.toggleClass("open"),
						e("#masthead").toggleClass("masthead-open");
				});
		}),
		(lsx.fix_bootstrap_menus_dropdown = function () {
			e(".navbar-nav .dropdown, #top-menu .dropdown").on(
				"show.bs.dropdown",
				function () {
					l < 1200 &&
						(e(this)
				...
				l > 1199 &&
					e(
						".navbar-nav li.dropdown a, #top-menu li.dropdown a"
					).each(function () {
						e(this).removeClass("dropdown-toggle"),
				...
				a.resize(function () {
					l > 1199
						...
						: e(
								...
								e(this).addClass("dropdown-toggle"),
			...
			l < 1200 &&
				(e(
					...
					e(this).parent().hasClass("open") ||
						...
						e(this).next(".dropdown-menu").dropdown("toggle"),
						o.stopPropagation(),
						o.preventDefault());
				}),
				e(
		...
		(lsx.fix_lazyload_envira_gallery = function () {
			e(".lazyload, .lazyloaded").length > 0 &&
				"object" == typeof envira_isotopes &&
				a.scroll(function () {
					e(".envira-gallery-wrap").each(function () {
						var o = e(this).attr("id");
						(o = o.replace("envira-gallery-wrap-", "")),
							"object" == typeof envira_isotopes[o] &&
								envira_isotopes[o].enviratope("layout");
					});
				});
		}),
		(lsx.set_main_menu_as_fixed = function () {
			var o = !1;
			l > 1199 &&
				e("body").hasClass("top-menu-fixed") &&
				n.on("scroll", function (s) {
					!1 === o &&
						(e(lsx_params.stickyMenuSelector).scrollToFixed({
							marginTop: function () {
								var o = e("#wpadminbar");
		...
		(lsx.set_cover_template_header_height = function () {
			var o = 0;
			(e("body").hasClass("page-template-template-cover") ||
				e("body").hasClass("post-template-template-cover")) &&
				((o = e("#masthead").outerHeight()),
				e("#masthead").css("margin-bottom", -Math.abs(o)));
		}),
		...
		a.load(function () {
			lsx.fix_bootstrap_menus_dropdown(),
				...
				e("body.preloader-content-enable").addClass("html-loaded");
		});
